...
async def radar_oportunidades(update: Update, context: ContextTypes.DEFAULT_TYPE):
    user_id = update.callback_query.message.chat_id
    await update.callback_query.message.reply_text("📡 Buscando oportunidades...")
    ...
    if oportunidades:
        mensaje = "🚨 *Oportunidades detectadas:*\n\n" + "\n\n".join(oportunidades)
    else:
        mensaje = "✅ No se encontraron oportunidades claras en este momento."
